...
object RestJSONHelper {
    fun restPostHelper(restTemplate: RestTemplate, url: String, request: Any, nurupo: String): ResponseJSON {
        return try {
    ...
    fun restGetHelper(restTemplate: RestTemplate, url: String, nurupo: String): ResponseJSON {
        return try {
